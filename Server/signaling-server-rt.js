...
io.sockets.on('connection', function (socket)
{
    ...
    socket.on('join', function (config)
	{
		...
		//***************************************************************************************
		// THIS IS SUPER IMPORTANT TO SETUP RIGHT FOR YOUR EXPERIMENTAL USE!
		// If we've got our users in this channel we're all set to start recording data
		// send out a message to all the clients to start the session
		/*
	...
	// YOU MAY NEED TO MODIFY THE BELOW TO SUIT YOUR SETUP
